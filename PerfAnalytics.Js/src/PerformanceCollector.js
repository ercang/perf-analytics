class PerformanceCollector {
    ...
    collectData() {
        ...
        const performanceData = {
            ...
            domLoadTime: this.getDOMLoadTime(),
            windowLoadTime: this.getWindowLoadTime(),
            resourceLoadTimings: this.getNetworkTimingsForResources()
        }
    ...
    getDOMLoadTime(p) {
        return p.timing.domComplete - p.timing.requestStart;
    }
...
window.perfAnalyticsInit = (serverUUID, apiEndPoint, extendedInformatio) => {
    new PerformanceCollector(serverUUID, apiEndPoint, extendedInformatio);
};
